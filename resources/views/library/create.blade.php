<x-layout title="Create Library">
    <div class="special_header">
        <span>
            ...
            {{ __('layout.create_library') }}
        </span>
    </div>
    <div class="form-data">
        <form action="/library" method="POST" class="create_form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group optional flex-1">
                ...
                <div class="uploadAttachments">
                    <input type="file" name="attachments[]" multiple id="files" style="display: none;">
                    <div class="files">
                        <i class="fal fa-cloud-upload"></i>
                    </div>
                </div>
            ...
            <div class="form-group flex-1">
                <button type="submit">{{ __('layout.create_library') }}</button>
            </div>
        </form>
    </div>
