<x-layout title="Create Event">
    <div class="special_header">
        <span>
            ...
            {{ __('layout.create_event') }}
        </span>
    </div>
    <div class="form-data">
        <form action="/events" method="POST" class="create_form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group required flex-1">
                ...
                <input type="text" name="end" id="end" value="{{ old('end') }}" />
                @error('end')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group flex-1">
                <button type="submit">{{ __('layout.create_event') }}</button>
            </div>
        </form>
    </div>
